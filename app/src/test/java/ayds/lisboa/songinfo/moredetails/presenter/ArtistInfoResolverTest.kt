...
class ArtistInfoResolverTest {
    ...
    @Test
    fun `given artist info and name and isLocallyStored, when getFormattedInfo is called, then returns formatted info in html`() {
        // Arrange
    ...
    @Test
    fun `given artist info and name and not isLocallyStored, when getFormattedInfo is called, then returns formatted info in html`() {
        // Arrange
